...
$(function () {
    ...
    $("#bounderies_button").buttonset();

    $('#bounderies_button input:radio').click(function () {
        var showFeatureType = $(this).val();
        var hideFeatureType = ($(this).val() === '1') ? '2' : '1';
        $('#wrsInputs' + hideFeatureType).hide();
        $('#wrsInputs' + showFeatureType).show();
    });
