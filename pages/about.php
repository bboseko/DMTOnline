            ...
            <div class="content">
                <div class="pageHeader">
                    <div style="margin-left: 30px;padding-top: 6px;" >
                        <a href="about.php?lang=<?php echo $_SESSION['lang']; ?>"><?php echo $lang['about-osfac-dmt'];?></a>  
                    </div>                    
                </div>
                <p align="justify">
                    <?php echo $lang['about-paragraph1'];?> 
                </p><br/>
                <img style="margin-left: 10px; float: right;" src="../images/dmt.png" alt="image2" width="180" height="168" />
                <p align="justify">
                    <?php echo $lang['about-paragraph2'];?>
                </p><br/>
                <div style="color: #000000;font-size: 13px;font-weight: bold;"><?php echo $lang['about-paragraph3-title'];?></div><br/>
                <p align="justify">
                    <?php echo $lang['about-paragraph3']?>
                </p><br/>
                <p align="justify">
                    <?php echo $lang['about-paragraph4']?>
                    <br/><br/>
                </p>
                <div style="color: #000000;font-size: 13px;font-weight: bold;"><?php echo $lang['about-paragraph5-title'];?></div><br/>
                <p align="justify">
                    <?php echo $lang['about-paragraph5'];?>
                </p>
            </div> 
        </div>
