            ...
            <div class="content">
                <div class="pageHeader">
                    <div style="margin-left: 30px;padding-top: 6px;" >
                        <a href="whatnew.php?lang=<?php echo $_SESSION['lang']; ?>"><?php echo $lang['whatsnew-title']; ?></a>  
                    </div>                    
                </div>
                <div align="justify" style="margin: 20px;font-size: 13px;color: #000000;">
                    <?php echo $lang['whatsnew-message1']; ?>
                    <ul style="margin: 20px;" type="circle">
                        <?php echo $lang['whatsnew-message2']; ?>
                    </ul>
                </div>
            </div> 
        </div>
