            ...
            <div class="content">
                <div class="pageHeader">
                    <div style="margin-left: 30px;padding-top: 6px;" >
                        <a href="desktop.php?lang=<?php echo $_SESSION['lang']; ?>">OSFAC-DMT Desktop</a>  
                    </div>                    
                </div>
                <div style="float: left;width: 64%;padding: 5px;text-align: justify;">
                    <?php echo $lang['desktop-col1-paragraph1']; ?>
                    <?php echo $lang['desktop-col1-paragraph2']; ?>
                </div>
                <?php echo $lang['desktop-col2']; ?>
            </div>
