            ...
            <div class="content">
                ...
                <div style="text-align: justify;font-size: 13px;color: #000000;margin: 20px;">
                    <div style="margin-bottom: 10px;">
                        Thank you for your interest to OSFAC-DMT Desktop. Your download should start automatically in a few seconds.
                    </div>
                    <p>
                ...
                <div style="font-size: 13px;text-align: justify;border:1px solid #71b24a;margin: 20px;padding: 20px;color: #000000;border-radius: 5px;">
                    <span style="font-weight: bold;text-transform: uppercase;">In this package, you have got:</span>
                    <ul type="circle" style="padding: 15px 30px;">
                        <li>OSFAC-DMT Desktop, Setup file (exe, 96 MB);</li>
                        <li>Installation Guide (PDF, 967 KB);</li>
                        <li>Tutorial (PDF, 2 MB).</li>
                    </ul>
                </div>
            </div>
        </div>       
