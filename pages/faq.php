            ...
            <div class="content">
                <div class="pageHeader">
                    <div style="margin-left: 30px;padding-top: 6px;" >
                        <a href="faq.php?lang=<?php echo $_SESSION['lang']; ?>"><?php echo $lang['faq-title']; ?></a>  
                    </div>                    
                </div>
                <div align="justify" style="margin: 5px 20px;font-size: 13px;color: #000000;">
                    <ul type="circle">
                        <li style="padding: 10px 0;">
                            <?php echo $lang['faq-message1']; ?>
                        </li>
                        <li style="padding: 10px 0;">
                            <?php echo $lang['faq-message2']; ?> 
                        </li>
                        <li style="padding: 10px 0;">
                            <?php echo $lang['faq-message3']; ?>
                        </li>
                        <li style="padding: 10px 0;">
                            <?php echo $lang['faq-message4']; ?>
                        </li>
                        <li style="padding: 10px 0;">
                            <?php echo $lang['faq-message5']; ?>
                        </li>
                        <li style="padding: 10px 0;">
                            <?php echo $lang['faq-message6']; ?>
                        </li>
                    </ul>
                </div>
            </div> 
